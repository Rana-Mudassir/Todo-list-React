...
"To-do List React" is a website to add list of work to do. It is a Single Page App (SPA) that allows users to:
...
```sh
  cd my-folder
  git clone https://github.com/Rana-Mudassir/todo-list-react
```
### Install
...
Feel free to check the [issues page](https://github.com/Rana-Mudassir/todo-list-react/issues).
